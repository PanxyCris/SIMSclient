...
/**
 * The class <code>ReceiptBillControllerTest</code> contains tests for the class
 * <code>{@link ReceiptBillController}</code>.
 *
 * @generatedBy CodePro at 18-1-12 下午9:20
 * @author asus
 * @version $Revision: 1.0 $
 */
public class ReceiptBillControllerTest {
	/**
	 * Run the ReceiptBillController() constructor test.
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:20
	 */
	@Test
	public void testReceiptBillController_1() throws Exception {
		ReceiptBillController result = new ReceiptBillController();
	...
	public void testCommit_1() throws Exception {
		ReceiptBillController fixture = new ReceiptBillController();
		fixture.receiptBillBL = new ReceiptBillBL();
		ReceiptBillVO receiptBillVO = new ReceiptBillVO("", "", "", BillType.INVENTORYBILL, BillState.COMMITED,
		...
		// bussinesslogic.accountbillbl.ReceiptBillController
	...
	/**
	 * Run the ArrayList<ReceiptBillVO> find(String,FindAccountBillType) method
	 * test.
	 *
	 * @throws Exception
	 *
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ReceiptBillControllerTest.class);
	}
}