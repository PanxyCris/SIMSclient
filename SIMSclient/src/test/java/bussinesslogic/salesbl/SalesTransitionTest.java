...
/**
 * The class <code>SalesTransitionTest</code> contains tests for the class <code>{@link SalesTransition}</code>.
 *
...
public class SalesTransitionTest {
	...
	public void testPOtoVO_1()
		throws Exception {
		SalesPO po = new SalesPO("", "", "", "", "", Warehouse.WAREHOUSE1, new ArrayList(), new ArrayList(), 1.0, 1.0, 1.0, 1.0, "", BillType.INVENTORYBILL, BillState.COMMITED);
