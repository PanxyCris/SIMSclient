...
public class UserDataTest {
	...
	/**
	 * Run the ArrayList<UserPO> find(String,FindUserType) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	/**
	 * Run the ResultMessage insert(UserPO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	/**
	 * Run the ArrayList<UserPO> show() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	/**
	 * Run the ResultMessage update(UserPO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(UserDataTest.class);
	}
}