...
/**
 * The class <code>ExamineReceiptBLTest</code> contains tests for the class <code>{@link ExamineReceiptBL}</code>.
 *
...
public class ExamineReceiptBLTest {
	 ...
	 */
	@Test
	public void testExamineReceiptBL_1()
		throws Exception {
		...
		//    java.lang.ClassNotFoundException: bussinesslogic.examinebl.ExamineReceiptBL
	...
	public void testUpdateBill_1()
		...
		ExamineReceiptBL fixture = new ExamineReceiptBL();
		fixture.tansition = new ReceiptBillTransition();
		ReceiptBillVO vo = new ReceiptBillVO("", "", "", BillType.INVENTORYBILL, BillState.COMMITED, new ArrayList(), new Double(1.0), "");
