...
/**
 * The class <code>PromotionSpecialBLTest</code> contains tests for the class
 * <code>{@link PromotionSpecialBL}</code>.
 *
...
public class PromotionSpecialBLTest {
	 ...
	 */
	@Test
	public void testPromotionSpecialBL_1() throws Exception {
		...
		// bussinesslogic.promotionbl.PromotionSpecialBL
	...
	public void testDelete_1() throws Exception {
		...
		PromotionPricePacksVO vo = new PromotionPricePacksVO("", LocalDate.MAX, LocalDate.MAX, new Double(1.0),
				new ArrayList());
	...
	/**
	 * Run the ArrayList<PromotionPricePacksVO> find(String,FindPromotionType)
	 * method test.
	 *
	 * @throws Exception
	 *
