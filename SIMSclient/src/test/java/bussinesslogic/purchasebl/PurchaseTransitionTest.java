...
/**
 * The class <code>PurchaseTransitionTest</code> contains tests for the class <code>{@link PurchaseTransition}</code>.
 *
...
public class PurchaseTransitionTest {
	...
	public void testPOtoVO_1()
		throws Exception {
		PurchasePO po = new PurchasePO("", "", "", Warehouse.WAREHOUSE1, "", new ArrayList(), "", 1.0, BillType.INVENTORYBILL, BillState.COMMITED);

		PurchaseVO result = PurchaseTransition.POtoVO(po);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ClassNotFoundException: bussinesslogic.purchasebl.PurchaseTransition
