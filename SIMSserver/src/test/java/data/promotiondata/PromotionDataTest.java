...
public class PromotionDataTest {
	...
	/**
	 * Run the ResultMessage insert(P) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:28
	...
	/**
	 * Run the ArrayList<PromotionPO> show() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:28
	...
	/**
	 * Run the ResultMessage update(P) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:28
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(PromotionDataTest.class);
	}
}