...
/**
 * The class <code>PurchaseDataServiceImplTest</code> contains tests for the class <code>{@link PurchaseDataServiceImpl}</code>.
 *
...
public class PurchaseDataServiceImplTest {
	 ...
	 */
	@Test
	public void testPurchaseDataServiceImpl_1()
		throws Exception {
	 ...
	 */
	@Test
	public void testDeletePurchase_1()
		throws Exception {
		...
		//       at data.purchasedata.PurchaseDataServiceImpl.deletePurchase(PurchaseDataServiceImpl.java:34)
		assertNotNull(result);
	}

	/**
	 * Run the ArrayList<PurchasePO> findPurchase(String,FindSalesType) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:26
	 */
	@Test
	public void testFindPurchase_1()
		throws Exception {
		PurchaseDataServiceImpl fixture = new PurchaseDataServiceImpl();
		String keyword = "";
		...
		//       at data.purchasedata.PurchaseDataServiceImpl.findPurchase(PurchaseDataServiceImpl.java:50)
		assertNotNull(result);
	}
	 ...
	 */
	@Test
	public void testInsertPurchase_1()
		throws Exception {
		PurchaseDataServiceImpl fixture = new PurchaseDataServiceImpl();
		PurchasePO po = new PurchasePO("", "", "", Warehouse.WAREHOUSE1, "", new ArrayList(), "", 1.0, BillType.INVENTORYGIFTBILL, BillState.COMMITED);
		...
		//       at data.purchasedata.PurchaseDataServiceImpl.insertPurchase(PurchaseDataServiceImpl.java:29)
		assertNotNull(result);
	}
	 ...
	 */
	@Test
	public void testShowPurchase_1()
		throws Exception {
		PurchaseDataServiceImpl fixture = new PurchaseDataServiceImpl();
		...
		//       at data.purchasedata.PurchaseDataServiceImpl.showPurchase(PurchaseDataServiceImpl.java:44)
		assertNotNull(result);
	}
	 ...
	 */
	@Test
	public void testUpdatePurchase_1()
		throws Exception {
		PurchaseDataServiceImpl fixture = new PurchaseDataServiceImpl();
		PurchasePO po = new PurchasePO("", "", "", Warehouse.WAREHOUSE1, "", new ArrayList(), "", 1.0, BillType.INVENTORYGIFTBILL, BillState.COMMITED);
		...
		//       at data.purchasedata.PurchaseDataServiceImpl.updatePurchase(PurchaseDataServiceImpl.java:39)
		assertNotNull(result);
	}
