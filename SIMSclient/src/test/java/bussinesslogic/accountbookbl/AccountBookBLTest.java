...
/**
 * The class <code>AccountBookBLTest</code> contains tests for the class <code>{@link AccountBookBL}</code>.
 *
 * @generatedBy CodePro at 18-1-12 下午9:20
 * @author asus
 * @version $Revision: 1.0 $
 */
public class AccountBookBLTest {
	/**
	 * Run the AccountBookBL() constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:20
	 */
	@Test
	public void testAccountBookBL_1()
		throws Exception {

		AccountBookBL result = new AccountBookBL();

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ClassNotFoundException: bussinesslogic.accountbookbl.AccountBookBL
	...
	public void testChoseByYear_1()
		throws Exception {
		AccountBookBL fixture = new AccountBookBL();
		int date = 1;
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AccountBookBLTest.class);
	}
}