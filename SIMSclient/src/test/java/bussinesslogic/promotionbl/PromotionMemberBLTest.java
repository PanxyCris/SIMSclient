...
/**
 * The class <code>PromotionMemberBLTest</code> contains tests for the class
 * <code>{@link PromotionMemberBL}</code>.
 *
...
public class PromotionMemberBLTest {
	 ...
	 */
	@Test
	public void testPromotionMemberBL_1() throws Exception {
		...
		// bussinesslogic.promotionbl.PromotionMemberBL
	...
	public void testDelete_1() throws Exception {
		...
		PromotionMemberVO vo = new PromotionMemberVO("", LocalDate.MAX, LocalDate.MAX, MemberLevel.LEVEL1,
	...
	/**
	 * Run the ArrayList<PromotionMemberVO> find(String,FindPromotionType)
	 * method test.
	 *
	 * @throws Exception
	 *
