...
| **触发条件** | 当实际库房中的商品损坏或者多于系统内商品数量时 |
| **前置条件** | 库存管理人员必须已经被识别和授权 |
| **后置条件** | 更新库存中的商品情况，并在时间日志中进行该次库存报溢、报损的记录 |
| **优先级** | 中 |
...
| **触发条件** | 当库存数量低于警戒数量值 |
| **前置条件** | 库存管理人员必须已经被识别和授权 |
| **后置条件** | 更新库存中的商品情况，并在时间日志中进行该次库存报警的记录 |
| **优先级** | 中 |
