...
/**
 * The class <code>ExaminePaymentBLTest</code> contains tests for the class <code>{@link ExaminePaymentBL}</code>.
 *
...
public class ExaminePaymentBLTest {
	 ...
	 */
	@Test
	public void testExaminePaymentBL_1()
		throws Exception {
		...
		//    java.lang.ClassNotFoundException: bussinesslogic.examinebl.ExaminePaymentBL
	...
	public void testUpdateBill_1()
		...
		ExaminePaymentBL fixture = new ExaminePaymentBL();
		fixture.tansition = new PaymentBillTransition();
		PaymentBillVO vo = new PaymentBillVO("", "", "", "", new ArrayList(), new Double(1.0), BillType.INVENTORYBILL, BillState.COMMITED, "");
