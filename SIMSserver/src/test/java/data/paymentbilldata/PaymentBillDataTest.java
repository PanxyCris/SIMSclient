 ...
 */
public class PaymentBillDataTest {
	/**
	...
	/**
	 * Run the ResultMessage insert(PaymentBillPO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	/**
	 * Run the ArrayList<PaymentBillPO> show() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	/**
	 * Run the ResultMessage update(PaymentBillPO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:27
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(PaymentBillDataTest.class);
	}
}