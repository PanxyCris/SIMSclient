...
/**
 * The class <code>ExamineInventoryBLTest</code> contains tests for the class
 * <code>{@link ExamineInventoryBL}</code>.
 *
...
public class ExamineInventoryBLTest {
	 ...
	 */
	@Test
	public void testExamineInventoryBL_1() throws Exception {
		...
		// bussinesslogic.examinebl.ExamineInventoryBL
	...
	/**
	 * Run the ResultMessage notPassBills(ArrayList<InventoryBillVO>) method
	 * test.
	 *
	 * @throws Exception
	 *
	 ...
	 */
	@Test
	public void testPassBills_12() throws Exception {
		ExamineInventoryBL fixture = new ExamineInventoryBL();
		fixture.transition = new InventoryTransition();
		ArrayList<InventoryBillVO> vos = new ArrayList();
