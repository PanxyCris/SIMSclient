...
/**
 * The class <code>ExaminePurchaseBLTest</code> contains tests for the class <code>{@link ExaminePurchaseBL}</code>.
 *
 * @generatedBy CodePro at 18-1-12 下午9:21
 * @author asus
 * @version $Revision: 1.0 $
 */
public class ExaminePurchaseBLTest {
	/**
	 * Run the ExaminePurchaseBL() constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:21
	 */
	@Test
	public void testExaminePurchaseBL_1()
		throws Exception {

		ExaminePurchaseBL result = new ExaminePurchaseBL();

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ClassNotFoundException: bussinesslogic.examinebl.ExaminePurchaseBL
	...
	/**
	 * Run the ArrayList<PurchaseVO> find(String,FindBillType) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:21
	...
	public void testFind_1()
		throws Exception {
		ExaminePurchaseBL fixture = new ExaminePurchaseBL();
		String info = "";
	...
	/**
	 * Run the ArrayList<PurchaseVO> getCommitedBills() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:21
	...
	public void testGetCommitedBills_1()
		...
		ArrayList<PurchaseVO> result = fixture.getCommitedBills();
	...
	/**
	 * Run the ResultMessage notPassBills(ArrayList<PurchaseVO>) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:21
	...
	public void testNotPassBills_1()
		throws Exception {
		ExaminePurchaseBL fixture = new ExaminePurchaseBL();
		ArrayList<PurchaseVO> vos = new ArrayList();
	...
	/**
	 * Run the ResultMessage passBills(ArrayList<PurchaseVO>) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:21
	...
	/**
	 * Run the ResultMessage updateBill(PurchaseVO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:21
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ExaminePurchaseBLTest.class);
	}
}