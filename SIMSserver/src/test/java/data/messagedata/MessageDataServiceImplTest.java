...
public class MessageDataServiceImplTest {
	/**
	 * Run the MessageDataServiceImpl() constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:28
	...
	/**
	 * Run the ArrayList<MessagePO> getMessage(UserPO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:28
	...
	/**
	 * Run the ResultMessage save(MessagePO) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18-1-12 下午9:28
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MessageDataServiceImplTest.class);
	}
}